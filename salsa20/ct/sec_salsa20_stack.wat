    ...
    (block
      (loop
        (br_if 1 (i32.ge_u (get_local $i) (i32.const 10)))
          ...
          (i32.const 80)
          (s32.load (i32.const 112))
          (s32.load (i32.const 64))
          (s32.add)
          (s32.const 7)
          (s32.rotl)
          (s32.load (i32.const 80))
          (s32.xor)
          (s32.store)
          ...
          (i32.const 100)
          (s32.load (i32.const 68))
          (s32.load (i32.const 84))
          (s32.add)
          (s32.const 7)
          (s32.rotl)
          (s32.load (i32.const 100))
          (s32.xor)
          (s32.store)
          ...
          (i32.const 120)
          (s32.load (i32.const 88))
          (s32.load (i32.const 104))
          (s32.add)
          (s32.const 7)
          (s32.rotl)
          (s32.load (i32.const 120))
          (s32.xor)
          (s32.store)
          ...
          (i32.const 76)
          (s32.load (i32.const 108))
          (s32.load (i32.const 124))
          (s32.add)
          (s32.const 7)
          (s32.rotl)
          (s32.load (i32.const 76))
          (s32.xor)
          (s32.store)
  ...
  (func $encrypt (export "encrypt") (param $bytes i32)
    ...
    (if (i32.ne (get_local $bytes) (i32.const 0))
      (then
        ...
        (set_local $mptr (i32.add (get_local $cptr) (i32.mul (get_local $bytes) (i32.const 4))));;(i32.const 64064))
        (block
          (loop
              ...
              (block
                (loop
                  (br_if 1 (i32.ge_u (get_local $i) (get_local $pub_scratch)))
                    ...
                    (get_local $i)
                    (i32.add)
                    (set_local $outval (s32.load))
                    (get_local $mptr)
                    (get_local $i)
                    (i32.add)
                    (set_local $mval (s32.load))
                    (get_local $cptr)
                    (get_local $i)
                    (i32.add)
                    (get_local $outval)
